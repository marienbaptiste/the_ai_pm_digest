      ...
      <svg viewBox="0 0 750 400" xmlns="http://www.w3.org/2000/svg" style="max-width: 100%; height: auto;">
        <style>
          ...
          @keyframes lstmForgetActivate {
            0%, 30% { fill: #ef444430; }
            50% { fill: #ef444480; }
            70%, 100% { fill: #ef444430; }
          }
          @keyframes lstmInputActivate {
            0%, 35% { fill: #3b82f630; }
            55% { fill: #3b82f680; }
            75%, 100% { fill: #3b82f630; }
          }
          @keyframes lstmOutputActivate {
            0%, 50% { fill: #00d4aa30; }
            70% { fill: #00d4aa80; }
            90%, 100% { fill: #00d4aa30; }
          }
        </style>
        ...
        <line x1="60" y1="85" x2="690" y2="85" stroke="#f59e0b" stroke-width="3"
        ...
        <text x="375" y="70" text-anchor="middle" class="lstm-label" style="animation-delay: 0.8s;"
          fill="#f59e0b" font-family="var(--font-heading)" font-size="13" font-weight="600">
          Cell State (C\u209C)
        </text>

        <!-- Animated pulse along cell state -->
        <circle r="5" fill="#f59e0b" opacity="0">
        ...
        <circle r="10" fill="#f59e0b" opacity="0" filter="url(#lstmGlow)">
          <animate attributeName="cx" values="80;670" dur="3s" repeatCount="indefinite" begin="1.5s"/>
          <animate attributeName="cy" values="85;85" dur="3s" repeatCount="indefinite" begin="1.5s"/>
        ...
        <text x="40" y="80" text-anchor="middle" class="lstm-label" style="animation-delay: 0.6s;"
          fill="#f59e0b" font-family="var(--font-mono)" font-size="10">C\u209C\u208B\u2081</text>
        ...
        <g class="lstm-box" style="animation-delay: 0.5s;">
          <rect x="140" y="145" width="100" height="70" rx="10"
            ...
            <animate attributeName="fill" values="#ef444420;#ef444460;#ef444420" dur="3s" repeatCount="indefinite" begin="2s"/>
          </rect>
          <text x="190" y="172" text-anchor="middle"
            fill="#ef4444" font-family="var(--font-heading)" font-size="12" font-weight="700">Forget Gate</text>
          <text x="190" y="200" text-anchor="middle"
            fill="#ef4444" font-family="var(--font-mono)" font-size="18" font-weight="700">\u03C3</text>
        </g>

        <!-- Forget gate output up to cell state -->
        <line x1="190" y1="145" x2="190" y2="85" stroke="#ef4444" stroke-width="1.5"
          class="lstm-flow" marker-end="url(#lstmArrowRed)"/>

        <!-- X (multiply) at forget gate junction -->
        <g class="lstm-box" style="animation-delay: 1s;">
          <circle cx="190" cy="85" r="12" fill="var(--bg-surface)" stroke="#ef4444" stroke-width="1.5"/>
          <text x="190" y="90" text-anchor="middle"
            fill="#ef4444" font-family="var(--font-mono)" font-size="14" font-weight="700">\u00D7</text>
        </g>
        ...
        <g class="lstm-box" style="animation-delay: 0.8s;">
          <rect x="300" y="145" width="100" height="70" rx="10"
            ...
            <animate attributeName="fill" values="#3b82f620;#3b82f660;#3b82f620" dur="3s" repeatCount="indefinite" begin="2.5s"/>
          </rect>
          <text x="350" y="172" text-anchor="middle"
            fill="#3b82f6" font-family="var(--font-heading)" font-size="12" font-weight="700">Input Gate</text>
          <text x="335" y="202" text-anchor="middle"
            fill="#3b82f6" font-family="var(--font-mono)" font-size="16" font-weight="700">\u03C3</text>
          <text x="365" y="202" text-anchor="middle"
            fill="#60a5fa" font-family="var(--font-mono)" font-size="12" font-weight="600">tanh</text>
        </g>

        <!-- Input gate output up to cell state -->
        <line x1="350" y1="145" x2="350" y2="85" stroke="#3b82f6" stroke-width="1.5"
          class="lstm-flow" marker-end="url(#lstmArrowBlue)"/>

        <!-- + (add) at input gate junction -->
        <g class="lstm-box" style="animation-delay: 1.2s;">
          <circle cx="350" cy="85" r="12" fill="var(--bg-surface)" stroke="#3b82f6" stroke-width="1.5"/>
          <text x="350" y="91" text-anchor="middle"
            fill="#3b82f6" font-family="var(--font-mono)" font-size="16" font-weight="700">+</text>
        </g>

        <!-- ===== Output Gate ===== -->
        <g class="lstm-box" style="animation-delay: 1.1s;">
          <rect x="460" y="145" width="100" height="70" rx="10"
            stroke="#00d4aa" stroke-width="2">
            <animate attributeName="fill" values="#00d4aa20;#00d4aa60;#00d4aa20" dur="3s" repeatCount="indefinite" begin="3s"/>
          </rect>
          <text x="510" y="172" text-anchor="middle"
            fill="#00d4aa" font-family="var(--font-heading)" font-size="12" font-weight="700">Output Gate</text>
          <text x="495" y="202" text-anchor="middle"
            fill="#00d4aa" font-family="var(--font-mono)" font-size="16" font-weight="700">\u03C3</text>
          <text x="525" y="202" text-anchor="middle"
            fill="#2dd4a8" font-family="var(--font-mono)" font-size="12" font-weight="600">tanh</text>
        </g>

        <!-- Output gate connection up -->
        <line x1="510" y1="145" x2="510" y2="85" stroke="#00d4aa" stroke-width="1" stroke-dasharray="3"/>

        <!-- X (multiply) at output gate junction -->
        <g class="lstm-box" style="animation-delay: 1.4s;">
          <circle cx="510" cy="85" r="12" fill="var(--bg-surface)" stroke="#00d4aa" stroke-width="1.5"/>
          <text x="510" y="90" text-anchor="middle"
            fill="#00d4aa" font-family="var(--font-mono)" font-size="14" font-weight="700">\u00D7</text>
        </g>

        <!-- Output arrow going right and up -->
        <path d="M510,85 L510,55 L690,55" fill="none" stroke="#00d4aa" stroke-width="2"
        ...
        <text x="620" y="48" text-anchor="middle" class="lstm-label" style="animation-delay: 1.6s;"
          fill="#00d4aa" font-family="var(--font-heading)" font-size="12" font-weight="600">
          h\u209C (output)
        </text>
        ...
        <g class="lstm-label" style="animation-delay: 1.6s;">
          ...
          <line x1="190" y1="265" x2="190" y2="215" stroke="#ef4444" stroke-width="1" stroke-dasharray="3"
            marker-end="url(#lstmArrowRed)"/>
          <line x1="350" y1="265" x2="350" y2="215" stroke="#3b82f6" stroke-width="1" stroke-dasharray="3"
            marker-end="url(#lstmArrowBlue)"/>
          <line x1="510" y1="265" x2="510" y2="215" stroke="#00d4aa" stroke-width="1" stroke-dasharray="3"
        ...
        <circle r="3" fill="#00d4aa" opacity="0">
