    ...
    <div style="text-align: center; width: 100%;">
      <svg viewBox="0 0 750 420" xmlns="http://www.w3.org/2000/svg" style="max-width: 100%; height: auto;">
        ...
        <g class="sl-fade" style="animation-delay: 0s;">
          <rect x="90" y="30" width="530" height="260" rx="4" fill="#11182790" stroke="var(--border-subtle)" stroke-width="1"/>
        </g>
        ...
        <path d="M 110 60 C 160 75, 200 110, 250 140 C 300 170, 350 195, 400 215 C 450 230, 500 242, 560 252 C 590 256, 610 258, 620 260"
          fill="none" stroke="#00d4aa" stroke-width="8" opacity="0.1" class="sl-curve"/>

        <!-- Model size dots on curve -->
        <g class="sl-dot" style="animation-delay: 2.6s;">
          <circle cx="155" cy="82" r="5" fill="#00d4aa"/>
          <text x="155" y="75" text-anchor="middle" font-family="var(--font-heading)" font-size="11" fill="#00d4aa" font-weight="600">1B</text>
        </g>

        <g class="sl-dot" style="animation-delay: 2.9s;">
          <circle cx="250" cy="140" r="5" fill="#00d4aa"/>
          <text x="250" y="133" text-anchor="middle" font-family="var(--font-heading)" font-size="11" fill="#00d4aa" font-weight="600">7B</text>
        </g>

        <g class="sl-dot" style="animation-delay: 3.2s;">
          <circle cx="380" cy="208" r="5" fill="#00d4aa"/>
          <text x="380" y="201" text-anchor="middle" font-family="var(--font-heading)" font-size="11" fill="#00d4aa" font-weight="600">70B</text>
        </g>

        <g class="sl-dot" style="animation-delay: 3.5s;">
          <circle cx="470" cy="236" r="6" fill="#3b82f6"/>
          <text x="470" y="229" text-anchor="middle" font-family="var(--font-heading)" font-size="11" fill="#3b82f6" font-weight="600">175B</text>
        </g>

        <g class="sl-dot" style="animation-delay: 3.8s;">
          <circle cx="565" cy="253" r="7" fill="#3b82f6"/>
          <text x="565" y="246" text-anchor="middle" font-family="var(--font-heading)" font-size="11" fill="#3b82f6" font-weight="600">540B</text>
        </g>

        <!-- Emergent abilities threshold line -->
        <line x1="380" y1="30" x2="380" y2="290" stroke="#ef4444" stroke-width="1.5" class="sl-threshold" style="animation-delay: 4.0s;"/>
        <g class="sl-fade" style="animation-delay: 4.2s;">
          <rect x="383" y="35" width="120" height="20" rx="4" fill="#ef444420"/>
          <text x="443" y="49" text-anchor="middle" font-family="var(--font-heading)" font-size="10" fill="#ef4444" font-weight="600">Emergent Threshold</text>
        </g>

        <!-- Emergent Abilities Section (below chart) -->
        <g class="sl-fade" style="animation-delay: 4.5s;">
          <text x="355" y="340" text-anchor="middle" class="sl-title" fill="#f59e0b">Emergent Abilities</text>
        ...
        <g class="sl-emerge" style="animation-delay: 4.8s;">
          <rect x="130" y="365" width="110" height="40" rx="8" fill="#f59e0b15" stroke="#f59e0b" stroke-width="1.5"/>
          <text x="151" y="383" font-size="14">&#129504;</text>
          <text x="172" y="388" font-family="var(--font-heading)" font-size="11" fill="#f59e0b" font-weight="600">Reasoning</text>
          <text x="185" y="400" text-anchor="middle" class="sl-label" fill="#f59e0b">Chain-of-thought</text>
        </g>

        <!-- Coding ability -->
        <g class="sl-emerge" style="animation-delay: 5.1s;">
          <rect x="260" y="365" width="90" height="40" rx="8" fill="#f59e0b15" stroke="#f59e0b" stroke-width="1.5"/>
          <text x="278" y="383" font-size="14">&#128187;</text>
          <text x="303" y="388" font-family="var(--font-heading)" font-size="11" fill="#f59e0b" font-weight="600">Coding</text>
          <text x="305" y="400" text-anchor="middle" class="sl-label" fill="#f59e0b">Program synth</text>
        </g>

        <!-- Math ability -->
        <g class="sl-emerge" style="animation-delay: 5.4s;">
          <rect x="370" y="365" width="90" height="40" rx="8" fill="#f59e0b15" stroke="#f59e0b" stroke-width="1.5"/>
          <text x="388" y="383" font-size="14">&#128202;</text>
          <text x="417" y="388" font-family="var(--font-heading)" font-size="11" fill="#f59e0b" font-weight="600">Math</text>
          <text x="415" y="400" text-anchor="middle" class="sl-label" fill="#f59e0b">Multi-step</text>
        </g>

        <!-- Translation ability -->
        <g class="sl-emerge" style="animation-delay: 5.7s;">
          <rect x="480" y="365" width="120" height="40" rx="8" fill="#f59e0b15" stroke="#f59e0b" stroke-width="1.5"/>
          <text x="498" y="383" font-size="14">&#127760;</text>
          <text x="534" y="388" font-family="var(--font-heading)" font-size="11" fill="#f59e0b" font-weight="600">Translation</text>
          <text x="540" y="400" text-anchor="middle" class="sl-label" fill="#f59e0b">Zero-shot</text>
        </g>

        <!-- Connecting arrows from threshold to abilities -->
        <g class="sl-fade" style="animation-delay: 4.6s;">
          <line x1="380" y1="290" x2="380" y2="340" stroke="#ef4444" stroke-width="1" stroke-dasharray="3 3" opacity="0.5"/>
          <polygon points="376,338 380,345 384,338" fill="#ef4444" opacity="0.5"/>
        </g>

        <!-- Legend -->
        <g class="sl-fade" style="animation-delay: 0.5s;">
          <rect x="635" y="60" width="105" height="80" rx="6" fill="#11182790" stroke="var(--border-subtle)" stroke-width="1"/>
          <line x1="645" y1="80" x2="665" y2="80" stroke="#00d4aa" stroke-width="2"/>
          <text x="670" y="84" class="sl-label" fill="var(--text-secondary)">Scaling law</text>
          <line x1="645" y1="100" x2="665" y2="100" stroke="#ef4444" stroke-width="1.5" stroke-dasharray="4 3"/>
          <text x="670" y="104" class="sl-label" fill="var(--text-secondary)">Threshold</text>
          <circle cx="655" cy="120" r="4" fill="#3b82f6"/>
